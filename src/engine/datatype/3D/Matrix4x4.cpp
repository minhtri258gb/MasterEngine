...
Matrix4x4& Matrix4x4::operator *= (const Matrix4x4& r)
{
	...
	return *this;
	// this->set(
	// 	r.m[ 0] * m[ 0] + r.m[ 4] * m[ 1] + r.m[ 8] * m[ 2] + r.m[12] * m[ 3],
	// 	r.m[ 1] * m[ 0] + r.m[ 5] * m[ 1] + r.m[ 9] * m[ 2] + r.m[13] * m[ 3],
	// 	r.m[ 2] * m[ 0] + r.m[ 6] * m[ 1] + r.m[10] * m[ 2] + r.m[14] * m[ 3],
	// 	r.m[ 3] * m[ 0] + r.m[ 7] * m[ 1] + r.m[11] * m[ 2] + r.m[15] * m[ 3],
	// 	r.m[ 0] * m[ 4] + r.m[ 4] * m[ 5] + r.m[ 8] * m[ 6] + r.m[12] * m[ 7],
	// 	r.m[ 1] * m[ 4] + r.m[ 5] * m[ 5] + r.m[ 9] * m[ 6] + r.m[13] * m[ 7],
	// 	r.m[ 2] * m[ 4] + r.m[ 6] * m[ 5] + r.m[10] * m[ 6] + r.m[14] * m[ 7],
	// 	r.m[ 3] * m[ 4] + r.m[ 7] * m[ 5] + r.m[11] * m[ 6] + r.m[15] * m[ 7],
	// 	r.m[ 0] * m[ 8] + r.m[ 4] * m[ 9] + r.m[ 8] * m[10] + r.m[12] * m[11],
	// 	r.m[ 1] * m[ 8] + r.m[ 5] * m[ 9] + r.m[ 9] * m[10] + r.m[13] * m[11],
	// 	r.m[ 2] * m[ 8] + r.m[ 6] * m[ 9] + r.m[10] * m[10] + r.m[14] * m[11],
	// 	r.m[ 3] * m[ 8] + r.m[ 7] * m[ 9] + r.m[11] * m[10] + r.m[15] * m[11],
	// 	r.m[ 0] * m[12] + r.m[ 4] * m[13] + r.m[ 8] * m[14] + r.m[12] * m[15],
	// 	r.m[ 1] * m[12] + r.m[ 5] * m[13] + r.m[ 9] * m[14] + r.m[13] * m[15],
	// 	r.m[ 2] * m[12] + r.m[ 6] * m[13] + r.m[10] * m[14] + r.m[14] * m[15],
	// 	r.m[ 3] * m[12] + r.m[ 7] * m[13] + r.m[11] * m[14] + r.m[15] * m[15]);
	// return *this;
}
